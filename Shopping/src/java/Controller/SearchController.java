...
public class SearchController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int total = proDao.countProductBySearch(txtSearch);
            int pageSize = 6;
            ...
            List<Product> listProSearch = pro.SearchProduct(txtSearch, index, pageSize);
            //get cate
            ...
            request.setAttribute("listPro", listProSearch);
