			...
			<div class="col py-12 ">
				...
				<div class="container">
					<div class="row" style="margin-top: 3%">
						<h1 style="margin-left: 5%">Add Trip</h1>
					...
					<div class="col-lg-9 col-12 ">
						...
						<form name="myform" action="<%=request.getContextPath()%>/add-trip" method="post">
							<!-- Destination -->
									...
									<div class="form-inline">
										...
										<div class="col-md-6 col-12 input-group">
											<input type="text" class="form-control "
												placeholder="Enter destination" maxlength="50" name="destination"
												value="" id="destination" required>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-12 bg-white">
									<div class="form-inline">
										<label for="phoneNumber"
											class="col-md-4 col-form-label justify-content-start "><b>Departure time
												</b>
											<p style="color: red">(*)</p> </label>
										<div class="col-md-6 col-12 input-group">
							...
							<div class="form-group ">
								<div class="col-lg-12 bg-white">
									<div class="form-inline">
										<label class="col-md-4 col-form-label  justify-content-start "><b>Car type
												</b>
											<p style="color: red">(*)</p> </label>
										<div class="col-md-6 col-12 input-group">
											<input type="text" class="form-control "
												placeholder="Enter car type" maxlength="50" name="carType"
												value="" id="carType" required>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="form-group ">
								<div class="col-lg-12 bg-white">
									<div class="form-inline">
										<label class="col-md-4 col-form-label  justify-content-start "><b>Maximum online ticket number
												</b>
											<p style="color: red">(*)</p> </label>
										<div class="col-md-6 col-12 input-group">
											<input type="number" class="form-control "
												placeholder="0" maxlength="50" name="ticket"
												value="" id="carType" required>
										</div>
									</div>
								</div>
							...
							<div class="form-group ">
								<div class="col-lg-12 bg-white">
									<div class="form-inline">
										<label for="phoneNumber"
											class="col-md-4 col-form-label justify-content-start "><b>Departure date
												</b>
											<p style="color: red">(*)</p> </label>
										<div class="col-md-6 col-12 input-group">
