			...
			<div class="col py-12 ">
				...
				<div class="container">
					<div class="row" style="margin-top: 3%">
						<h1 style="margin-left: 5%">Update Car</h1>
					...
					<div class="col-lg-9 col-12 ">
						...
						<form name="myform"
							action="<%=request.getContextPath()%>/list-car?action=update"
							method="post">
							<!-- License plate -->
									...
									<div class="form-inline">
										...
										<div class="col-md-6 col-12 input-group">
											<input type="text" class="form-control " maxlength="50"
												name="licensePlate" value="${car.licensePlate}"
												id="licensePlate" readonly required>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="form-group ">
								<div class="col-lg-12 bg-white">
									<div class="form-inline">
										...
										<div class="col-md-6 col-12 input-group">
											<input type="text" class="form-control " maxlength="50"
												name="carType" value="${car.carType}" id="carType" required>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-12 bg-white">
									<div class="form-inline">
										<label for="phoneNumber"
											class="col-md-4 col-form-label justify-content-start "><b>Car
												color</b> </label>
										<div class="col-md-6 col-12 input-group">
											<input class="form-control" type="text" maxlength="50"
												name="carColor" value="${car.carColor}" id="carColor"
												required>
										</div>
									</div>
								</div>
