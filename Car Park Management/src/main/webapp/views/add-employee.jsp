			...
			<div class="col py-12 ">
				...
				<div class="container">
					<div class="row" style="margin-top: 3%">
						<h1 style="margin-left: 5%">Add Employee</h1>
					...
					<div class="col-lg-9 col-12 ">
						...
						<form name="myform" action="<%=request.getContextPath()%>/add-employee" method="post">
							<!-- Full name -->
									...
									<div class="form-inline">
										...
										<div class="col-md-6 col-12 input-group">
											<input type="text" class="form-control "
												...
												value="" id="phoneNumber" onChange="CheckPhone()" required>
									...
									<div class="form-inline">
										...
										<div class="col-md-6 col-12 input-group">
											<input type="radio" name="sex" value="1"
												style="margin: 2%" checked> <label for="male"
												style="margin: 1%"> Male</label> <input type="radio"
												name="sex" value="0" style="margin: 2%"> <label
												for="female" style="margin: 1%"> Female</label>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-inline">
										...
										<div class="col-md-6 col-12 input-group">
											<input class="form-control" type="text" name="Address"
												value="" id="Address" placeholder="Enter address">
									...
									<div class="form-inline">
										...
										<div class="col-md-6 col-12 input-group">
											<input class="form-control" type="text" name="Account"
												value="" id="Account" placeholder="Enter Account" required>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="form-inline">
										...
										<div class="col-md-6 col-12 input-group">
											...
											<input class="form-control" type="password" name="Password"
												value="" id="Password" placeholder="Enter Password"
