				...
				<div class="row" style="height: auto;">
					...
					<div class="container">
						<div class="col-xl-12 white-text text-center text-md-left ">
							<h1 style="color: black">Booking Office List</h1>
							<hr class="hr-light">
						</div>
						...
						<form action="<%=request.getContextPath()%>/listBookingOffice">
							<div class="card ">
								<div class="card-body">
								...
								<ul class="pagination">
									<c:if test="${index > 1}">
										<li class="page-item"><a class="page-link"
											href="listBookingOffice?index=${index-1}">Previous</a></li>
									</c:if>
									...
									<c:if test="${maxPage >= 1}">
										...
										<c:forEach begin="1" end="${maxPage}" var="i">
											<li class="page-item"><a class="page-link ${i==index?"
												active":""}" href="listBookingOffice?index=${i}">${i}</a></li>
										</c:forEach>
									</c:if>
									<c:if test="${index < maxPage}">
										<li class="page-item"><a class="page-link"
											href="listBookingOffice?index=${index+1}">Next</a></li>
									</c:if>
								</ul>
							</nav>
						</form>
