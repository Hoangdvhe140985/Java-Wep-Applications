						...
						<ul class="pagination">
							<c:if test="${index > 1}">
								<li class="page-item"><a class="page-link"
									href="<%=request.getContextPath()%>/trip?action=searchTrip&day=${day}&month=${month}&year=${year}&index=${index - 1}">Previous</a></li>
							</c:if>
							<li class="page-item"><a class="page-link"
								href="<%=request.getContextPath()%>/trip?action=searchTrip&day=${day}&month=${month}&year=${year}&index=${index}">${index}</a></li>
							<c:if test="${index < numberOfPage}">
								<li class="page-item"><a class="page-link"
									href="<%=request.getContextPath()%>/trip?action=searchTrip&day=${day}&month=${month}&year=${year}&index=${index + 1}">Next</a></li>
							</c:if>
						</ul>
					</nav>
				</div>
