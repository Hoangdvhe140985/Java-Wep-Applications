				...
				<div class="row" style="height: auto;">
					...
					<div class="container">
						<div class="row" style="margin-top: 3%">
							<h1 style="margin-left: 5%">Add Booking Office</h1>
										...
										<div class="form-inline">
											...
											<div class="col-md-6 col-12 input-group">
												<input type="text" class="form-control "
													...
													name="phone" id="phoneNumber" onChange="CheckPhone()"
													required>
										...
										<div class="form-inline">
											...
											<div class="col-md-6 col-12 input-group">
												<input type="text" class="form-control " placeholder="Price"
													maxlength="50" name="price" id="fullname" required>
												<label>(VND)</label>
											</div>
										</div>
									</div>
										...
										<div class="form-inline">
											...
											<div class="col-md-6 col-12 input-group">
												<span class="input-group-text"><i class=""
													...
													placeholder="yyyy-mm-dd" type="date" name="to" id=""
													required>
											</div>
